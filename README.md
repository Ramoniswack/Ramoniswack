...
```json
{
  ...
  "code"         : ["Python", "TypeScript", "JavaScript", "PHP", "Java"],
  "frontend"     : ["Next.js", "React", "Flutter", "Tailwind CSS"],
  "backend"      : ["FastAPI", "Django", "Node.js", "Express", "Laravel"],
  "data"         : ["PostgreSQL", "MongoDB", "MySQL", "Redis"],
  "ai"           : ["LLM Integration", "MCP", "OpenAI", "Anthropic"],
  "devops"       : ["Docker", "Linux", "Nginx", "GitHub Actions", "Azure"],
  "currentFocus" : "Building scalable SaaS & AI-powered products",
  "openTo"       : ["Full-Time Roles", "Freelance", "Collaboration"],
  "funFact"      : "Code by day, chord progressions by night."
}
```
...
![Anthropic](https://img.shields.io/badge/Anthropic_API-191919?style=for-the-badge)
![LLM Integration](https://img.shields.io/badge/LLM_Integration-7AA2F7?style=for-the-badge)
![MCP](https://img.shields.io/badge/MCP-24283B?style=for-the-badge)
![AEO / SEO](https://img.shields.io/badge/AEO_%2F_SEO-BB9AF7?style=for-the-badge&logo=google&logoColor=white)
...
![S3](https://img.shields.io/badge/S3_Compatible-569A31?style=for-the-badge&logo=amazons3&logoColor=white)
